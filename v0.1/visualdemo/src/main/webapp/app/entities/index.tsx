...
const Routes = ({ match }) => (
  <div>
    <Switch>
      ...
      <ErrorBoundaryRoute path={`${match.url}sortingVisualizer`} component={SortingVisualizer} />
      <ErrorBoundaryRoute path={`${match.url}graphVisualizer`} component={GraphVisualizer} />
    </Switch>
  </div>
);
