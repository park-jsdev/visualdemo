...
export class JobHistoryDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('visualdemoApp.jobHistory.delete.question'));
...
export default class JobHistoryComponentsPage {
  ...
  async deleteJobHistory() {
    ...
    expect(await jobHistoryDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/visualdemoApp.jobHistory.delete.question/);
