...
export class LocationDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('visualdemoApp.location.delete.question'));
...
export default class LocationComponentsPage {
  ...
  async deleteLocation() {
    ...
    expect(await locationDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/visualdemoApp.location.delete.question/);
