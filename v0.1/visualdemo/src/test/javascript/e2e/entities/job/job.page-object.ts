...
export class JobDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('visualdemoApp.job.delete.question'));
...
export default class JobComponentsPage {
  ...
  async deleteJob() {
    ...
    expect(await jobDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/visualdemoApp.job.delete.question/);
