...
export class TaskDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('visualdemoApp.task.delete.question'));
...
export default class TaskComponentsPage {
  ...
  async deleteTask() {
    ...
    expect(await taskDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/visualdemoApp.task.delete.question/);
