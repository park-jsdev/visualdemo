...
export class DepartmentDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('visualdemoApp.department.delete.question'));
...
export default class DepartmentComponentsPage {
  ...
  async deleteDepartment() {
    ...
    expect(await departmentDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/visualdemoApp.department.delete.question/);
